...
export function PrivacyScreen() {
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <Text style={styles.body}>
        Manages App Store purchase and entitlement status, including Lifetime access and existing legacy subscriptions. Receives an anonymous app user ID and Apple purchase receipts. Does not receive your location, health data, observations, or any personal content. Privacy policy: revenuecat.com/privacy
      </Text>
